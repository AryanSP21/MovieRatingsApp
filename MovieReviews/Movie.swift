...
struct Movie: Identifiable, Codable {
    ...
    static let allMovies: [Movie] = [
        ...
        Movie(id: "Batman", title: "The Dark Knight", year: 2010, description: "I am Batman", posterImage: "batman", rating: 0),
        Movie(id: "Godfather", title: "The Godfather", year: 1985, description: "akjhahdkahdaJdjajda", posterImage: "godfather", rating: 0),
        Movie(id: "Parasite", title: "Parasite", year: 2018, description: "adbhjdjahdgjagjgdjajhdgjdgjagagdjhgagjh", posterImage: "parasite", rating: 0),
        Movie(id: "Interstellar", title: "Interstellar", year: 2012, description: "Man going to space", posterImage: "interstellar", rating: 0),
        Movie(id: "Transformers", title: "Transformers", year: 1985, description: "Autobots Roll Out...", posterImage: "transformers", rating: 0),
    ]
}
